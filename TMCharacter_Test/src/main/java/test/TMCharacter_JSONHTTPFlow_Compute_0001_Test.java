...
public class TMCharacter_JSONHTTPFlow_Compute_0001_Test {

	/*
	 * TMCharacter_JSONHTTPFlow_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.7.0 on Dec 30, 2022 9:13:30 AM
	 */
	...
	@Test
	public void TMCharacter_JSONHTTPFlow_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("TMCharacter")
				.messageFlow("JSONHTTPFlow").node("Compute");
        ...
        assertEquals(stringToCompare, actualMessageAssembly.messagePath("JSON.Data.response").getStringValue());	
    }
}
